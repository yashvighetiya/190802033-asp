        ...
        <div class="container py-md-3">
            <div class="row banner-grids">
                <div class="col-md-6 banner-image">
                    <div class="effect-w3">
                        <img src="src_client/images/about.jpg" alt="" class="img-fluid image1">
            ...
            <div class="row">
                <div class="col-md-6 latest-left">
                    <div class="product-shoe-info shoe text-center">
                        <img src="src_client/images/img1.jpg" class="img-fluid" alt="">
                        <div class="shop-now"><a href="shop.aspx" class="btn">Shop Now</a></div>
                    </div>
                </div>
                <div class="col-md-6 latest-right">
                    <div class="row latest-grids">
                        <div class="latest-grid1 product-men col-12">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="src_client/images/img2.jpg" class="img-fluid" alt="">
                                    <div class="shop-now"><a href="shop.aspx" class="btn">Shop Now</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="latest-grid2 product-men col-12 mt-lg-4">
                            <div class="product-shoe-info shoe text-center">
                                <div class="men-thumb-item">
                                    <img src="src_client/images/img3.jpg" class="img-fluid" alt="">
                                    <div class="shop-now"><a href="shop.aspx" class="btn">Shop Now</a></div>
