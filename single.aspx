<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="single.aspx.cs" Inherits="_Default" %>
            ...
            <div class="speak px-lg-5">
                <div class="row mt-lg-5 mt-4">
                    <div class="col-md-12 events-img">
                        <img src="src_client/images/single.jpg" class="img-fluid" alt="user-image" />
                    </div>
                ...
                <div class="row my-lg-5 my-3">
                    ...
                    <div class="col-md-6 team-img">
                        <img src="src_client/images/img6.jpg" class="img-fluid" alt="user-image" />
                    </div>
                </div>
                ...
                <div class="media py-5">
                    <img src="src_client/images/te2.jpg" class="mr-3 img-fluid rounded-circle" alt="image">
                    <div class="media-body">
                        ...
                        <div class="media mt-5">
                            <a class="pr-3" href="#">
                                <img src="src_client/images/te1.jpg" class="img-fluid rounded-circle" alt="image">
                            </a>
                            <div class="media-body">
